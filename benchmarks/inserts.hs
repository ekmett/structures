...
buildV3 :: Int -> V.Map Int Int
buildV3 n = F.foldl' (flip (join V.insert3)) V.empty $ take n $ randoms (mkStdGen 1)
...
main = defaultMain
  ...
  , bench "COLA insert3 10k"     $ nf buildV3 10000
  , bench "Data.Map insert 10k"  $ nf buildM 10000
  , bench "COLA insert 100k"     $ nf buildV 100000
  , bench "COLA insert3 100k"    $ nf buildV3 100000
